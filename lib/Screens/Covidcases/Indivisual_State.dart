...
class indivisualstate extends StatefulWidget {
  ...
  indivisualstate({this.index,this.logo});
  @override
  _indivisualstateState createState() => _indivisualstateState(index:index,logo:logo);
}
...
class _indivisualstateState extends State<indivisualstate> {
  ...
  _indivisualstateState({this.index,this.logo});
  @override
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text("Stay Safe    Save Life",style: TextStyle(fontSize: 30),)
                      ],
                    ),
                    SizedBox(height: 10,),
                    Row(
